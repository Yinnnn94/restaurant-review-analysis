...
from wordcloud import WordCloud
>>>>>>> 9077f369e378a24efc7e3ff0f10b62d0dd33472a
...
>>>>>>> 9077f369e378a24efc7e3ff0f10b62d0dd33472a
    ...
    # Word cloud
<<<<<<< HEAD
    wc = WordCloud(width=500, height=300, background_color="rgba(255, 255, 255, 0)", mode="RGBA").generate(combined_text)
=======
...
<<<<<<< HEAD
        ...
        combine_text = " ".join(summary)
        st.header(f'Comment of {option}')
        st.write(summary)

        bar_fig, wc_img = plot_keywords(option)
=======
        # Summary
